...
def test_authenticate():
    ...
    credential, profile = DeviceCodeCredential.authenticate(
        client_id,
...
def test_silent_auth_only():
    ...
    credential = DeviceCodeCredential("client-id", silent_auth_only=True, transport=transport, _cache=empty_cache)
